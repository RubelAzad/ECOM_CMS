    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <!-- /entry heading -->
                @if (permission('user-group-add'))
                <button class="btn btn-primary btn-sm" onclick="showStoreFormModal('Add New User Group','Save')">
                    ...
                    <form id="form-filter">
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter user group name">
                            </div>
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('usergroup.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
        ...
        "buttons": [
            @if (permission('usergroup-report'))
            {
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url = "{{route('usergroup.store.or.update')}}";
        ...
        if (id) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#store_or_update_form #group_description').val(data.group_description);
    ...
    // Set the selected values
                    ...
                    $('#store_or_update_modal .modal-title').html(
                        '<i class="fas fa-edit"></i> <span>Edit ' + data.group_name + '</span>');
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#view_modal .modal-title').html(
                        '<i class="fas fa-eye"></i> <span>User Group Details</span>');
                },
                error: function (xhr, ajaxOption, thrownError) {
                    console.log(thrownError + '\r\n' + xhr.statusText + '\r\n' + xhr.responseText);
                }
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let url   = "{{ route('usergroup.delete') }}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('usergroup.bulk.delete')}}";
    ...
    $(document).on('click', '.change_status', function () {
        ...
        let name  = $(this).data('name');
        let row   = table.row($(this).parent('tr'));
        let url   = "{{ route('usergroup.change.status') }}";
