            ...
            <div class="col-xl-12">
                ...
                <div class="dt-entry__header">
                    ...
                    @if (permission('comboimage-add'))
                        <button id="add-new" class="btn btn-primary btn-sm" onclick="showFormModal('Add New Combo Image','Save')">
...
@push('script')
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            // var picker = $('#image').spartanMultiImagePicker({
                    ...
                    success: function (data) {
                        ...
                        if (data.status == false) {
                            ...
                            if (data.status == 'success') {
                                ...
                                // $('#image').empty();
                                // if(!picker){
                                //     picker = $('#image').spartanMultiImagePicker({
                                //         fieldName: 'fileUpload[]',
                                //         rowHeight: '100px',
                                //         groupClassName: 'col-md-4 com-sm-4 com-xs-4',
                                //         maxFileSize: '',
        ...
        $(document).ready(function() {
            ...
            $('.spartan_remove_row').removeClass('hidden-remove');
            $('.img_').removeClass('img_add');
        });
        ...
        //     j++;
        //
        //     $('.spartan_remove_row').addClass('hidden-remove');
        //     $('.img_').addClass('img_add');
        //     $('.img_').after('<i class="fa fa-times icon"></i>');
        // });
