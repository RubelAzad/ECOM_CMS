    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <!-- /entry heading -->
                @if (permission('picture-add'))
                <button class="btn btn-primary btn-sm" onclick="showFormModal('Add New Picture','Save');clearOldImage()">
                    ...
                    <form id="form-filter">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="Picture Name">
                            </div>
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('picture.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url = "{{route('picture.store.or.update')}}";
        ...
        if (id) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#store_or_update_form #gallery_category_id').val(data.gallery_category_id);
                    $('#store_or_update_form #description').val(data.description);
                    $('#store_or_update_form #old_image').val(data.image);
                    $('#store_or_update_form .selectpicker').selectpicker('refresh');
                    if(data.image){
                        var image = "{{ asset('storage/'.PICTURE_IMAGE_PATH)}}/"+data.image;
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('picture.bulk.delete')}}";
    ...
    $(document).on('click', '.change_status', function () {
        ...
        let name  = $(this).data('name');
        let row   = table.row($(this).parent('tr'));
        let url   = "{{ route('picture.change.status') }}";
