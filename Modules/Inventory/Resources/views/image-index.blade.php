    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <!-- /entry heading -->
                @if (permission('inventoryimage-add'))
                <button class="btn btn-primary btn-sm" onclick="showFormModal('Add New Inventory Image','Save');">
                    ...
                    <form id="form-filter">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Inventory Name">
                            </div>
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('inventoryimage.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
                data._token      = _token;
            }
        ...
        "buttons": [
            @if (permission('inventoryimage-report'))
            {
    ...
    $(document).on('click', '#save-btn', function (event) {
        ...
        let url = "{{route('inventoryimage.store.or.update')}}";
        ...
        if (id) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#store_or_update_form #inventory_id').val(data.inventory_id);
                    $('#store_or_update_form #old_image').val(data.image);
                    $('#store_or_update_form .selectpicker').selectpicker('refresh');
                    if(data.image){
                        var image = "{{ asset('storage/'.INVENTORY_MULTI_IMAGE_PATH)}}/"+data.image;
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let url   = "{{ route('inventoryimage.delete') }}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('inventoryimage.bulk.delete')}}";
    ...
    $(document).on('click', '.change_status', function () {
        ...
        let name  = $(this).data('name');
        let row   = table.row($(this).parent('tr'));
        let url   = "{{ route('inventoryimage.change.status') }}";
