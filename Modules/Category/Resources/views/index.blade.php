        ...
        if (id) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#store_or_update_form #category_text').val(data.category_text);
                    $('#store_or_update_form #old_image').val(data.image);
                    $('#store_or_update_form .selectpicker').selectpicker('refresh');
                    if(data.image){
                        var image = "{{ asset('storage/'.CATEGORY_IMAGE_PATH)}}/"+data.image;
                    ...
                    if(data.lifestyle_image){
                        var image2 = "{{ asset('storage/'.CATEGORY_IMAGE_PATH)}}/"+data.lifestyle_image;
